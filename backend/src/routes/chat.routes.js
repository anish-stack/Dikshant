...
router.post("/admin-message", ChatController.adminMessage)
...
router.get("/complete-data/:videoId", ChatController.getCompleteChatData);
router.get("/analytics/:videoId", ChatController.getChatAnalytics);
...
router.get("/history/:videoId", ChatController.getChatHistory);
